...
print(f'\n\nSummary of Total Sales per Month')
print(f'----------------------------')
with open('Project/sales.csv', 'r') as csv_file:    # Displays list of each month's total sales
    ...
    print(months_dict)
month = input('\nWhat month do you want to see total sales for? ') 
sales = 0
for object in months_dict:      # Displays certain month's total sales
    if object['month'] == month:
        print(f'The total sales for the month of {month} was ${object['total_sales']}.00\n')